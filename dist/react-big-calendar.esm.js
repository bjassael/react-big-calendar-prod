...
var TimeGutter = function TimeGutter(_ref2) {
  ...
  return /*#__PURE__*/ React.createElement(
    ...
    /*#__PURE__*/ React.createElement(
      ...
      slotMetrics.groups
        .slice(1, slotMetrics.groups.length)
        .map(function (grp, idx) {
          return /*#__PURE__*/ React.createElement(TimeSlotGroup, {
            key: idx,
            group: grp,
            resource: resource,
            ...
            /*#__PURE__*/ React.createElement(
              'select',
              {
                onChange: function onChange(option) {
                  _this2.view.bind(null, option.target.value)()
                },
              },
          ...
          return viewNames.map(function (name) {
            return /*#__PURE__*/ React.createElement(
              'option',
              {
                ...
                key: name,
                value: name,
                // onClick={() => this.view.bind(null, option.target.value)}
                className: clsx({
